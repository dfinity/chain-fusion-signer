...
pub const CALLER_ETH_ADDRESS: &str = "0xDFB554B25A5fC2F44aEc0fCd8b541F065Ac33C0a";
pub const CALLER_BTC_ADDRESS_MAINNET: &str = "bc1qmrfmudl3j6jy3jf9aqvsk47cf3nyqw5kwx0nhx"; // Depends on pocket-ic version.
