...
#[derive(CandidType, Deserialize, Debug, Eq, PartialEq, Clone)]
pub(crate) enum SignerSchnorrPublicKeyError {
  SigningError,
  PaymentError(PaymentError),
}
pub(crate) type Result8 = std::result::Result<
  (EcdsaPublicKeyResponse,), SignerSchnorrPublicKeyError
>;
#[derive(CandidType, Deserialize, Debug, Eq, PartialEq, Clone)]
...
pub(crate) type Result9 = std::result::Result<(SignWithEcdsaResponse,), ()>;
...
impl SignerPic {
  ...
  pub fn schnorr_caller_public_key(&self, caller: Principal, arg0: &SchnorrPublicKeyArgument, arg1: &Option<PaymentType>) -> Result<Result8, String> {
      self.update(caller, "schnorr_caller_public_key", (arg0, arg1, ))
  }
  pub fn schnorr_sign(&self, caller: Principal, arg0: &Option<PaymentType>, arg1: &SignWithSchnorrArgument) -> Result<Result9, String> {
